 ...
 */
export function applyStickerWearNodes(material: StickerPhysicalNodeMaterial, stickerId: string, backing = false, preparedDamage: Pick<StickerDamageResource, 'texture'> | null = material.map === null ? null : prepareStickerDamage(material.map, stickerId)) {
  ...
  return {
    ...
    setDamage(resource: Pick<StickerDamageResource, 'texture'> | null) { damageMap.value = resource?.texture ?? empty; enabled.value = resource !== null; },
