...
import { createStickerCornerCage, type StickerBendFootprint } from '/Users/vinicius/code/webPod/docs/workstreams/015-listening-sticker-collection/evidence/sticker-edge-wrap/early/footprint-support-1/instrumented-cage';
...
export function createStickerWrapSurface(form: DeviceFormParams, faces: readonly StickerWrapFace[]) {
  ...
  return {
    cornerCage(centerX: number, centerY: number, footprint: StickerBendFootprint) {
      return createStickerCornerCage(centerX, centerY, form, rightProfile(0), front.height, footprint);
    },
  };
}
