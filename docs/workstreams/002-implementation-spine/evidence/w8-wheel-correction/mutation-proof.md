...
| D | White ink `#7B838E → #5E646D`, restoring the then-rejected darker treatment | `bun test packages/device/src/materials.test.ts` | **red:** 1 failed, 10 passed; received old color. **Superseded:** the owner's nine original OEM photographs later established light/white ink; see `owner-primary/mutation-proof.md`. |
