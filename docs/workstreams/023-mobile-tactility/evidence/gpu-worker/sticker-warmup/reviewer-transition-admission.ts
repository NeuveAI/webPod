...
const packetOwner={},reusePacket=Bun.env.REVIEW_PACKET_REUSE!=='off';
if(sent){try{
 ...
 try {
  ...
  try{
   ...
   try{
    ...
    const nextRecipe=createStickerPackRecipe(nextScene,nextPack,{width:300,height:315,pixel:1,x:0,y:0,workspaceLowering:0},true);
