...
/** Smallest thumb that remains legible in the nine-pixel Aqua trough. */
...
/**
 * Renders the panel-owned, nine-pixel Aqua scroll trough for an authoritative row window.
 *
