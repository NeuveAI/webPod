...
Status: Development startup repair independently approved and committed as bb1eb21. See dev-runtime-incident.md for the failure and exact-script validation added after the owner's report. Prior production approval did not validate this launch path and was insufficient for the earlier completion claim. Tracker is this workstream; no Kanban or neuve shell applies.
