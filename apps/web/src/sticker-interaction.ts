...
export function supersedeStickerInteraction(): void { deviceStore.set(stickerCollectionTransitionAtom, null); interactionGeneration += 1; deviceStore.set(stickerToolEditorPropertyAtom, null); stopStickerAnimation(); deviceStore.set(stickerPackTurnAtom, 0) }
