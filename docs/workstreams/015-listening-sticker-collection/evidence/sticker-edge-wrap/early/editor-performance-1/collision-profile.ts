import {collisionProfile} from './collision-baseline-instrumented';
...
import {createStickerVisibility,stickerVisibilityQuery} from './visibility-instrumented';
...
await Bun.write(import.meta.dir+'/contour-instrumented.json',JSON.stringify(result,null,2));console.log(JSON.stringify(result));vis.dispose();material.dispose();shell.dispose();

await Bun.write(import.meta.dir+'/collision-profile.json',JSON.stringify(collisionProfile,null,2));console.log(collisionProfile);
