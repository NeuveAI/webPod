...
Emulating viewport: {"deviceScaleFactor":1,"isMobile":false,"hasTouch":false,"isLandscape":false,"width":375,"height":812}
## Summary of Performance trace findings:
URL: http://127.0.0.1:55696/
Trace bounds: {min: 514851750908µs, max: 514864508059µs}
CPU throttling: 1x
...
URL: http://127.0.0.1:55696/
Bounds: {min: 514851750908µs, max: 514864508059µs}
Metrics (lab / observed):
  - INP: 16 ms, event: (eventKey: s-41615, ts: 514851959807)
  - CLS: 0.00
Metrics (field / real users): n/a – no data for this page in CrUX
Available insights:
  - insight name: INPBreakdown
    description: Start investigating [how to improve INP](https://developer.chrome.com/docs/performance/insights/inp-breakdown) by looking at the longest subpart.
    relevant trace bounds: {min: 514851959807µs, max: 514851975957µs}
  ...
  - insight name: Cache
    ...
    relevant trace bounds: {min: 514851997168µs, max: 514852001532µs}
    estimated wasted bytes: 2.1 MB
