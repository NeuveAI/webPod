...
/** Fixed Aqua well travel in authored panel pixels (full 183px pane). */
export const LIST_SCROLL_TRACK_SIZE_PX = 183

/** Smallest thumb that remains legible in the seven-pixel Aqua trough. */
...
/**
 * Renders the panel-owned, seven-pixel Aqua scroll trough for an authoritative row window.
 *
