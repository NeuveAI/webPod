...
await Bun.write(import.meta.dir+'/soft-continuation-64.json',JSON.stringify(results,null,2));console.log(results.map(r=>({name:r.name,last:r.trace.at(-1)})));collider.dispose();shell.dispose();
