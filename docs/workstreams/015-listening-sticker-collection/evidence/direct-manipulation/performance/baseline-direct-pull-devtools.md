...
Trace bounds: {min: 514923104524µs, max: 514923551074µs}
CPU throttling: 1x
...
URL: http://127.0.0.1:55696/
Bounds: {min: 514923104524µs, max: 514923551074µs}
Metrics (lab / observed):
  - INP: 74 ms, event: (eventKey: s-3081, ts: 514923208454)
  - CLS: 0.00
Metrics (field / real users): n/a – no data for this page in CrUX
Available insights:
  - insight name: INPBreakdown
    description: Start investigating [how to improve INP](https://developer.chrome.com/docs/performance/insights/inp-breakdown) by looking at the longest subpart.
    relevant trace bounds: {min: 514923208454µs, max: 514923282224µs}
...
## INPBreakdown follow-up (transcribed from actual MCP response)

The longest interaction was pointerdown,74ms total: input delay0.1ms, processing1ms, presentation72ms. No field data or measured GPU dropped-frame count is inferred. The MCP drag was a single short native drag with only three recorded progress mutations; it verifies a baseline endpoint path, not continuous slow/reverse tracking. The revised profile must add segmented continuous movement evidence.
