...
for (const [width, height] of [[320,568],[390,844],[844,390],[1280,900]]) {
 ...
 await page.screenshot({path:`${import.meta.dirname}/${width}x${height}.png`})
 ...
 await page.waitForTimeout(100)
 await page.screenshot({path:`${import.meta.dirname}/${width}x${height}-rotated.png`})
...
await Bun.write(`${import.meta.dirname}/measurements.json`,JSON.stringify(results,null,2))
